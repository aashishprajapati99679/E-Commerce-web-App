...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      console.log(error);
      toast.error("Something went wrong ckeck console");
  ...
  return (
    ...
    <form action="" onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write product description here' rows={4} required />
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-1 sm:w-[120px]' type="Number" placeholder='25' required />
        </div>

      </div>


      {/* here i'm trying to make the four box for sizes */}
      <div>
      ...
      <button type='submit' className='w-25 py-2 mt-4 bg-black text-white'>ADD</button>
