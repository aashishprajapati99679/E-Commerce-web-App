...
const Login = ({ setToken }) => {
    ...
    return (
        <div className='min-h-screen flex items-center justify-center w-full'>
            <div className='border-white shadow-md max-w-md rounded-lg px-8 py-6'>
                ...
                <form action="" onSubmit={onSubmitHandler} >
                    ...
                    <div className='mb-2 min-w-72'>
                        ...
                        <input
                            ...
                            value={password}
                            className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="password" placeholder='Enter Password' required />
                    </div>
                    <button
